...
| `compact` | src/agent/sessions/compaction.cljs | src/agent/extensions/claude_hook_bridge/events/compact.cljs, src/agent/extensions/token_suite/kv_cache.cljs, src/agent/modes/pi_rpc.cljs | after, before, summary, trigger |
