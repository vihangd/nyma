...
| `registerSettingsDefaults` | src/agent/extension_loader.cljs | `:settings` in src/agent/cli.cljs, src/agent/commands/builtins.cljs, src/agent/core.cljs, src/agent/modes/interactive.cljs, src/agent/sessions/compaction.cljs, src/agent/settings/manager.cljs, src/agent/utils/validation.cljs |
